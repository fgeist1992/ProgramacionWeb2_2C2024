...
<main class="container mx-auto max-sm:px-6 py-2.5 max-w-screen-x2 ">
    <form action="" class="flex max-sm:flex-col">
        ...
        <input type="submit" name="buscar" value="Quien es este Pokemon" style="cursor:pointer;"
               class="mt-1 mr-1 px-2 py-2 bg-blue-700 text-white hover:bg-blue-800  shadow-sm border-slate-300  block w-1/4 rounded-md sm:text-sm focus:ring-1  max-sm:w-full"/>
        <a href="subirNuevoPokemon.php" style="cursor:pointer;"
           class="mt-1 px-2 py-2 bg-blue-700 text-white hover:bg-blue-800  shadow-sm border-slate-300  block w-1/4 rounded-md sm:text-sm focus:ring-1  max-sm:w-full text-center">Nuevo</a>
    </form>
    <div class="overflow-auto">
        <table class="w-full">
            ...
            function mostrarPokemon($pokemon)
            {
                ...
                echo '<td><a href="info.php?id=' . $pokemon['numero'] . '"><img src="' . $pokemon['imagen'] . '"></a></td>';
                ...
                echo '<td><button class="bg-yellow-300 p-2 mr-2 rounded-md mb-1"><a href="modificar.php?id=' . $pokemon['numero'] . '">Modificar</a></button>';
                echo '<button class="bg-red-600 p-2 text-white rounded-md"><a href="eliminar.php?id=' . $pokemon["numero"] . '">Eliminar</a></button></td>';
                echo '</tr>';
            }
